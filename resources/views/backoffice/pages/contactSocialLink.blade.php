...
@section('content')
    <div class="container">
            ...
            <tbody>
                @foreach ($contactSocialLink as $item)
                    <tr>
                        ...
                        <td>{{ $item->name }}</td>
                        <td>{{ $item->icon }}</td>
                        <td><a class="btn btn-success" href="/edit-contactSocialLink/{{$item->id}}">Edit</a></td>
                        <td><a class="btn btn-danger" href="/delete-contactSocialLink/{{$item->id}}">Delete</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        @endif
        <form action="/store-contactSocialLink" method="POST">
            @csrf
