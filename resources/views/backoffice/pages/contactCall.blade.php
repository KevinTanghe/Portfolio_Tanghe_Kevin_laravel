...
@section('content')
    <div class="container">
            ...
            <tbody>
                @foreach ($contactCall as $item)
                    <tr>
                        ...
                        <td>{{ $item->icon }}</td>
                        <td>{{ $item->title }}</td>
                        <td><a class="btn btn-success" href="/edit-contactCall/{{$item->id}}">Edit</a></td>
                        <td><a class="btn btn-danger" href="/delete-contactCall/{{$item->id}}">Delete</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        @endif
        <form action="/store-contactCall" method="POST">
            @csrf
