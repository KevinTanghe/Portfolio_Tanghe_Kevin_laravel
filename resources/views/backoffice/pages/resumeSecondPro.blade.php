...
@section('content')
    <div class="container">
        <table class="table">
            ...
            <tbody>
                @foreach ($secondPro as $item)
                    <tr>
                        <th scope="row">{{ $item->id }}</th>
                        <td>{{ $item->title }}</td>
                        <td>{{ $item->years }}</td>
                        <td>{{ $item->lieu }}</td>
                        <td><a class="btn btn-success" href="/edit-resumeSecondPro/{{$item->id}}">Edit</a></td>
                        <td><a class="btn btn-danger" href="/delete-resumeSecondPro/{{$item->id}}">Delete</a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        @endif
        <form action="/store-resumeSecondPro" method="POST">
            @csrf
