...
@section('content')
    <div class="container">
        ...
        @endif
        <form action="/update-aboutTitle/{{ $edit->id }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="exampleInputEmail1">Ombre Titre</label>
                <input type="text" name="ombreTitre" value="{{ old('ombreTitre') ? old('ombreTitre') : $edit->ombreTitre}}" class="form-control" id="exampleInputEmail1"
